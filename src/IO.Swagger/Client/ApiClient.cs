...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://localhost:5002/api");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:5002/api).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:5002/api")
        {
